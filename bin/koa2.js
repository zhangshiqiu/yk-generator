...
function createApplication(app_name, path) {
    ...
    //config
    var configDevelopment= loadTemplate('js/config/development.js');
    var configProduct= loadTemplate('js/config/product.js');
    var configLocal= loadTemplate('js/config/local.js');
    mkdir(path, function(){
        mkdir(path + '/public');
        ...
        mkdir(path + '/public/styles', function(){
            switch (program.css) {
                ...
                case 'stylus':
                    ...
                    break;
                case 'compass':
                    write(path + '/public/styles/style.scss', compass);
                    break;
                case 'sass':
                    write(path + '/public/styles/style.sass', sass);
                    break;
                default:
        ...
        mkdir(path+'/config',function () {
            ...
            configDevelopment= configDevelopment.replace('<<xxx>>','<<'+app_name+'>>');
            configLocal= configLocal.replace('<<xxx>>','<<'+app_name+'>>');
            configProduct= configProduct.replace('<<xxx>>','<<'+app_name+'>>');
            write(path+'/config/development.js',configDevelopment);
            write(path+'/config/local.js',configLocal);
            write(path+'/config/product.js',configProduct);
            complete();
        });
        //loader
        mkdir(path+'/loader',function () {
            copy_template('js/loader/index.js',path+'/loader/index.js');
            copy_template('js/loader/loader.js',path+'/loader/loader.js');
            copy_template('js/loader/convert.js',path+'/loader/convert.js');
            copy_template('js/loader/param.js',path+'/loader/param.js');
            complete();
        });

        //controls
        mkdir(path+'/src',function () {
            mkdir(path+'/src/controls',function () {
                copy_template('js/controls/base.js',path+'/src/controls/base.js');
                copy_template('js/controls/index.js',path+'/src/controls/index.js');
                complete();
            });
        });
        //middleware
        mkdir(path+'/middleware',function () {
            copy_template('js/middleware/index.js',path+'/middleware/index.js');
            complete();
        });
