...
class validateParamMiddle{
  static validate(ctx,rules){
    ...
    for(let key of keys){
      ...
      let value= validateParamMiddle.validateValue(params,ctx);
  ...
  static validateValue(params,ctx){
    let value= ctx[params['position']][params['name']];
